...
_DATA_DIR    = Path(os.environ.get("RETRIEVAL_DATA_DIR", "/workshop/retrieval_aws/data"))
DENSE_NPZ    = _DATA_DIR / "embeddings_bge_dense.npz"
SPARSE_JSONL = _DATA_DIR / "embeddings_sparse.jsonl"
TEXTS_JSONL  = _DATA_DIR / "listing_texts_en.jsonl"
BGE_MODEL    = os.environ.get("BGE_MODEL_DIR", "/workshop/models/bge-m3")
ONNX_PATH    = os.environ.get("BGE_ONNX_DIR", "/workshop/models/bge-m3-onnx")
